...
Speed get_speed(uint16 time)
{
    ...
    if(distance_calc_flag)
    {
        ...
        car_info.distance += ((float)temp_pulse_left + temp_pulse_right) * 5.9 / 2;
    }
    // 计算速度 速度单位:mm/s
    // speed.left = (int16)(temp_pulse_left * 5913.411764705883 / time);
    // speed.right = (int16)(temp_pulse_right * 5913.411764705883 / time);
    speed.left = (int16)((float)temp_pulse_left * 5913.4 / time);
    speed.right = (int16)((float)temp_pulse_right * 5913.4 / time);
